    ...
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnResume()
        {
            ...
            else
            {
                ...
                //_nfcAdapter.EnableReaderMode(this, pendingIntent, filters, null);
            }
        }
        ...
        //    var rawMessages = intent.GetParcelableArrayListExtra(NfcAdapter.ExtraNdefMessages);

        //    //var rawMessages = intent.GetParcelableArrayExtra(NfcAdapter.ExtraData);
        ...
        protected override void OnNewIntent(Intent intent)
        {
            ...
            if (intent.Action == NfcAdapter.ActionTagDiscovered)
            {
                ...
                if (tag != null)
                {
                    ...
                    var alertMessage = new Android.App.AlertDialog.Builder(this).Create();
                    alertMessage.SetMessage("CardId:" + hexstring); // Here's the id of card
                    alertMessage.Show();
                    var parcelables = intent.GetParcelableArrayExtra(NfcAdapter.ExtraNdefMessages);

                    if (parcelables != null)
                    {
                        var alertMessages = new Android.App.AlertDialog.Builder(this).Create();
                        alertMessages.SetMessage("Card Details:" + hexstring);
                        alertMessages.Show();
                        //var abc = rawMessages.JavaCast<NdefMessage>();
                    ...
                    {
                        var alertMessagesss = new Android.App.AlertDialog.Builder(this).Create();
                        alertMessagesss.SetMessage("Card Details" + "No Details are present");
                        alertMessagesss.Show();
                    }
                }
            }
        }
